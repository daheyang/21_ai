{
  ...
  "cells": [
    ...
    },
    {
      ...
      "source": [
        "교차 기본 값은 3겹 교차 검증이므로 정확도 값이 3개가 반환된다. 기존 코드 또한 3겹 교차 검증이었으나, cv 매개변수 값을 바꾸어 폴드의 수를 9개로 늘리고 검증을 하였더니 교차 검증 정확도의 평균값이 98.7%로 기존 코드의 값보다 조금 더 높게 측정된 것을 확인할 수 있었다.\n",
        "\n",
